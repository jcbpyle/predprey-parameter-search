# -*- coding: utf-8 -*-
"""
Created on Fri Jan 12 14:19:14 2018

@author: James
"""

##############################################################################
#Batch job script for GA paramter searching Predator/Prey, single thread/GPU version
...
if not os.path.exists(PATH_TO_CURR+GATYPE):
        os.makedirs(PATH_TO_CURR+GATYPE)
SAVEPATH += GATYPE+"/"
...
#   prey_energy, grass_regrow, candidate_number
...
def evalPP(x):
    ...
    evalAuxillary(0, x, int(STAT_RUNS/GPUS_AVAILABLE))
...
for p in population:
    print("individual: "+str(p)+", fitness: "+str(p.fitness.values)+"\n")
print(logbook)